...
The national curriculum, governed by the National Council of Educational Research and
Training (NCERT), is used by hundreds of millions of students across thousands of schools.
Yet the digital resources available to those students are either in English or severely
limited in quality for regional languages.

The government's own digital platforms---ePathshala and DIKSHA---put the textbooks online
and attach some video content.
This is better than nothing, but the structure is the same linear, grade-then-chapter
organisation as the printed book.
There is no way for a student to discover what foundational idea they are missing,
no link between related concepts across different chapters, and no map of where any
topic fits in the larger picture.
It is a digitised textbook, not an educational tool.

Paid platforms like Toppr and Embibe are designed for competitive examination drilling.
They are expensive, examination-focused rather than concept-focused,
and their regional language support beyond Hindi is thin.

Khan Academy is closer to the right idea---it has prerequisite maps and reasonably
structured content---but it is built for the American curriculum and poorly aligned
with Indian boards.
Its regional language content, where it exists, is generally an inconsistent translation
of the English material rather than content written for Indian school students.
